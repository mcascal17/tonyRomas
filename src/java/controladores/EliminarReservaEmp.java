 ...
 * @author macar
 */
@WebServlet(name = "EliminarReservaEmp", urlPatterns = {"/EliminarReservaEmp"})
public class EliminarReservaEmp extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Long id=Long.parseLong(request.getParameter("id"));
            ...
            String from ="macarioc7@gmail.com";
            ...
            try{
                ...
                response.sendRedirect("reservasEmpleado.jsp?error="+error);
            }
            String mensaje= "Se ha eliminado la reserva";
            request.setAttribute("mensaje", mensaje);
            getServletContext().getRequestDispatcher("/reservasEmpleado.jsp").forward(request, response);
    }
