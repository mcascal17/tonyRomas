...
<%-- 
    ...
    Created on : 19-abr-2021, 11:17:46
    Author     : macar
--%>
        ...
        <div class="container bg-light my-5">
            <div class="row p-5">
                ...
                <div class="text-center">
                    <h3 class="fw-bolder m-2">${login}</h3>
                ...
                <div class="">
                        ...
                        <form class="form-group row" action="EditarCliente" method="post">
                        ...
                        <label class="col-xl-2 mb-3" for="confirmacion">Confirmar contraseña </label><input class="col-xl-10 mb-3 " name="confirmacion" id="direccion" type="text" value="">
